...
export function ClearHeadLogoLink({ className = "" }: ClearHeadLogoLinkProps) {
  return (
    <Link
      href="/"
      className={`group rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2d5a4a] focus-visible:ring-offset-2 ${className}`}
